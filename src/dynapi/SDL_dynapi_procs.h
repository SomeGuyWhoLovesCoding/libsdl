...
SDL_DYNAPI_PROC(double,SDL_GetTicks,(void),(),return)
SDL_DYNAPI_PROC(double,SDL_GetPerformanceCounter,(void),(),return)
SDL_DYNAPI_PROC(double,SDL_GetPerformanceFrequency,(void),(),return)
SDL_DYNAPI_PROC(void,SDL_Delay,(double a),(a),)
SDL_DYNAPI_PROC(SDL_TimerID,SDL_AddTimer,(double a, SDL_TimerCallback b, void *c),(a,b,c),return)
